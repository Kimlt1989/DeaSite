...
public class UpdateGameSerlvet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String bcancel = mrequest.getParameter("cancel");
            if (bcancel == null) {
                bcancel = "";
            } else {
                response.sendRedirect("adminManageFilm.jsp");
            }
            ...
            if (bsubmit == null) {
                ...
                if (!files.isEmpty()) {
                    int oldGameId = Integer.parseInt(mrequest.getParameter("oldGamesId"));
                    GameDAO gameDAO = new GameDAO();
//                    Film oldFilm = filmDAO.findExactlyFilm(oldFilmId);
                    String appPath = request.getRealPath("/images/GameImages");
//                    String oldFileUrl1 = appPath + "/" + oldFilm.getCover();
//                    String oldFileUrl2 = appPath + "/" + oldFilm.getCoverThumb();
...
//                    oldFile2.delete();
                    ...
                    int category = Integer.parseInt(mrequest.getParameter("genreCheckbox"));
                    ...
                    boolean result = gameDAO.updateGames(game, mrequest.getParameter("oldGamesId"));
                    if (result) {
//                      
                        out.write("<script type='text/javascript'>\n");
                        out.write("alert('Done');\n");
                        out.write("setTimeout(function(){window.location.href='adminManageFilm.jsp'},1000);");
                        out.write("</script>\n");
                    } else {
                        out.write("<script type='text/javascript'>\n");
