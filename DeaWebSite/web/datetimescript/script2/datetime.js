...
function fDrawCal(iYear, iMonth, iCellHeight, iDateTextSize) {
  ...
  var styleTD = " bgcolor='"+gcBG+"' bordercolor='"+gcBorder+"' valign='middle' align='center' height='"+iCellHeight+"' style='font:bold "+iDateTextSize+" ËÎÌו;";            //Coded by Liming Weng(Victor Won) email:victorwon@netease.com
...
write("<B style='cursor:hand;font:bold ËÎÌו' onclick='fSetDate(giYear,giMonth,giDay)' onMouseOver='this.style.color=gcToggle' onMouseOut='this.style.color=0'>Today :</B> "+giMonth+"/"+ giDay+"/"+giYear+" (mm/dd/yy)");
write("</TD></TR>");
write("</TABLE></Div>");
}
...
function isDate(dateStr) 
{
    ...
    if (matchArray == null) {
       // alert("Vui long nhap dinh dang ngay la`  ngay/thang/nam or ngay-thang-nam.");
        alert("Please format date mm/dd/yyyy or mm-dd-yyyy");
        return false;
    }
    ...
    if (month < 1 || month > 12) { // check month range
        ...
        alert("You must choose the month between 1 and 12");
        return false;
    }

    if (day < 1 || day > 31) {
        //alert("ngay phai giua 1 va 31.");
        alert("You must choose thhe month between 1 and 31");
        return false;
    }

    if ((month==4 || month==6 || month==9 || month==11) && day==31) {
       // alert("thang "+month+" khong co' ngay 31!")
        alert("This month "+month+" doesn't exists date 31!")
        return false;
    }
    ...
    if (month == 2) { // check for february 29th
        ...
        if (day > 29 || (day==29 && !isleap)) {
            ...
            alert("This month of the " + year + " doesn't exists  " + day + " date!");
            return false;
        }
    }
